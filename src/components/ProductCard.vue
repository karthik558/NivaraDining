...
<template>
  <article class="group flex h-full flex-col rounded-2xl border border-line bg-white p-2.5 hover:-translate-y-1 hover:border-lilac/30 hover:shadow-card">
    <div class="relative aspect-[1/0.86] overflow-hidden rounded-xl bg-warm">

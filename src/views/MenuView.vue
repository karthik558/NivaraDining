...
<template>
  <section class="relative min-h-130 overflow-hidden bg-[#142420] text-white lg:min-h-147.5">
    ...
    <div class="absolute inset-0 bg-linear-to-r from-[#142420] via-[#142420]/88 to-[#142420]/15"></div>
    <div class="absolute inset-0 bg-[radial-gradient(circle_at_15%_10%,rgba(18,78,63,.72),transparent_38%)]"></div>
